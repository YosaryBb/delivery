...
import 'package:delivery/mainScreens/parcel_picking_screen.dart';
...
class ShipmentAddressDesign extends StatelessWidget {
  ...
  final String? orderBayUser;

  ShipmentAddressDesign({this.model, this.orderStatus, this.orderId,this.sellerId,this.orderBayUser});
                ...
                child: Center(
                  child: InkWell(
                    onTap: () {
                      ...
                      confirmedParcelShipment(context,orderId!,sellerId!, orderBayUser!);
                    },
                    child: Container(
